...
export const builderCatalog = {
  triggers: [
    {
      ...
      conditions: ["channel"],
      actions: ["NOTIFY_STAFF", "SEND_CUSTOMER_SMS", "SEND_CUSTOMER_WHATSAPP"],
    ...
    },
    {
      ...
      actions: ["ASSIGN_LEAD", "NOTIFY_STAFF", "SEND_CUSTOMER_SMS", "SEND_CUSTOMER_WHATSAPP"],
      variables: ["name", "business_name"],
    },
    {
  ...
  actions: [
    ...
    { id: "SEND_CUSTOMER_WHATSAPP", label: "Send approved WhatsApp template" },
  ],
  variables: [
