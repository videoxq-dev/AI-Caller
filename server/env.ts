...
const envSchema = z.object({
  ...
  BRAND_ASSET_S3_BUCKET: z.string().min(1).optional(),
  BRAND_ASSET_S3_REGION: z.string().min(1).default("us-east-1"),
  BRAND_ASSET_S3_ENDPOINT: z.string().url().optional(),
  BRAND_ASSET_S3_ACCESS_KEY_ID: z.string().min(1).optional(),
  BRAND_ASSET_S3_SECRET_ACCESS_KEY: z.string().min(1).optional(),
