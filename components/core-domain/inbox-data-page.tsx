        ...
        <div className="unifiedInboxGrid">
          ...
          <section className="threadColumn">
            {timeline ? <>
              ...
              <div className="composerWrap"><div className="composerTabs"><button className="active" type="button">Message</button></div><textarea disabled placeholder={`Outbound ${channelLabels[latestChannel]} transport is enabled in its later channel milestone.`} /><div className="composerFooter"><span>Milestone 3 persists and reads the unified timeline; live sending is intentionally not simulated.</span></div></div>
